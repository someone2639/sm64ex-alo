...
OBJECT_WITH_ACTS(0,341,5,36,0,0,0,&VB_sa_1_0xe05b520[6],editor_Scroll_Texture,31),
OBJECT_WITH_ACTS(0,341,4,36,0,0,0,&VB_sa_1_0xe05acb0[11],editor_Scroll_Texture,31),
RETURN()
};
