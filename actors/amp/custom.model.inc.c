...
const Vtx VB_amp_geo_0x8002c10[] = {
...
const Vtx VB_amp_geo_0x8002b18[] = {
...
const Vtx VB_amp_geo_0x8002cf8[] = {
...
const Vtx VB_amp_geo_0x8002de0[] = {
...
gsDPSetTextureImage(0, 2, 1, texture_amp_geo_0x8001318_custom),
gsDPLoadSync(),
...
gsDPSetTextureImage(0, 2, 1, texture_amp_geo_0x8000f18_custom),
gsDPLoadSync(),
...
gsDPSetTextureImage(0, 2, 1, texture_amp_geo_0x8002318_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
gsDPSetTextureImage(0, 2, 1, texture_amp_geo_0x8001b18_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
