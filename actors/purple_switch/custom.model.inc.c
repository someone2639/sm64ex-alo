...
const Vtx VB_purple_switch_geo_0x800c528[] = {
...
const Vtx VB_purple_switch_geo_0x800c628[] = {
...
gsDPSetTextureImage(0, 2, 1, texture_purple_switch_geo_0x800c0a8_custom),
gsDPLoadSync(),
...
gsDPSetTextureImage(0, 2, 1, texture_purple_switch_geo_0x800c128_custom),
gsDPLoadSync(),
