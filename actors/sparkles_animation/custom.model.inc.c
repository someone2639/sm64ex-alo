...
const Vtx VB_sparkles_animation_geo_0x4032a48[] = {
...
gsDPPipeSync(),
gsDPSetTextureImage(3, 2, 1, texture_sparkles_animation_geo_0x4032a88_custom),
...
gsDPPipeSync(),
gsDPSetTextureImage(3, 2, 1, texture_sparkles_animation_geo_0x4033288_custom),
gsSPBranchList(DL_sparkles_animation_geo_0x4035288),
};

const Gfx DL_sparkles_animation_geo_0x4035330[] = {
gsDPPipeSync(),
gsDPSetTextureImage(3, 2, 1, texture_sparkles_animation_geo_0x4033a88_custom),
gsSPBranchList(DL_sparkles_animation_geo_0x4035288),
};

const Gfx DL_sparkles_animation_geo_0x4035348[] = {
gsDPPipeSync(),
gsDPSetTextureImage(3, 2, 1, texture_sparkles_animation_geo_0x4034288_custom),
gsSPBranchList(DL_sparkles_animation_geo_0x4035288),
};

const Gfx DL_sparkles_animation_geo_0x4035360[] = {
gsDPPipeSync(),
gsDPSetTextureImage(3, 2, 1, texture_sparkles_animation_geo_0x4034a88_custom),
gsSPBranchList(DL_sparkles_animation_geo_0x4035288),
};
