...
const Vtx VB_exclamation_box_outline_geo_0x8024d18[] = {
...
const Vtx VB_exclamation_box_outline_geo_0x8024e08[] = {
...
const Vtx VB_exclamation_box_outline_geo_0x8025008[] = {
...
const Vtx VB_exclamation_box_outline_geo_0x80250e8[] = {
...
const Vtx VB_exclamation_box_outline_seg8_dl_08025F08_0x8025e80[] = {
...
const Light_t Light_exclamation_box_outline_geo_0x8024cc0 = {
{ 255, 0, 0}, 0, { 255, 0, 0}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_exclamation_box_outline_geo_0x8024cb8 = {
{127, 0, 0}, 0, {127, 0, 0}, 0
};

const Gfx DL_exclamation_box_outline_geo_0x8024f88[] = {
...
const Gfx DL_exclamation_box_outline_geo_0x8024f30[] = {
gsDPPipeSync(),
...
const Gfx DL_exclamation_box_outline_geo_0x8024f58[] = {
...
const Gfx DL_exclamation_box_outline_geo_0x8024eb8[] = {
...
const Light_t Light_exclamation_box_outline_geo_0x8024cd8 = {
{ 0, 255, 0}, 0, { 0, 255, 0}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_exclamation_box_outline_geo_0x8024cd0 = {
{0, 127, 0}, 0, {0, 127, 0}, 0
};

const Gfx DL_exclamation_box_outline_geo_0x8024fa8[] = {
gsSPDisplayList(DL_exclamation_box_outline_geo_0x8024f30),
...
const Light_t Light_exclamation_box_outline_geo_0x8024cf0 = {
{ 0, 0, 255}, 0, { 0, 0, 255}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_exclamation_box_outline_geo_0x8024ce8 = {
{0, 0, 127}, 0, {0, 0, 127}, 0
};

const Gfx DL_exclamation_box_outline_geo_0x8024fc8[] = {
gsSPDisplayList(DL_exclamation_box_outline_geo_0x8024f30),
...
const Light_t Light_exclamation_box_outline_geo_0x8024d08 = {
{ 255, 212, 0}, 0, { 255, 212, 0}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_exclamation_box_outline_geo_0x8024d00 = {
{127, 106, 0}, 0, {127, 106, 0}, 0
};

const Gfx DL_exclamation_box_outline_geo_0x8024fe8[] = {
gsSPDisplayList(DL_exclamation_box_outline_geo_0x8024f30),
...
const Gfx DL_exclamation_box_outline_geo_0x80259f8[] = {
gsDPPipeSync(),
...
gsDPSetTextureImage(0, 2, 1, texture_exclamation_box_outline_geo_0x8025168_custom),
gsDPLoadSync(),
...
gsDPSetTextureImage(0, 2, 1, texture_exclamation_box_outline_seg8_dl_08025F08_0x8025a80_custom),
gsDPLoadSync(),
