...
const Vtx VB_bully_geo_0x5002c68[] = {
...
const Vtx VB_bully_geo_0x5002d48[] = {
...
const Vtx VB_bully_geo_0x5002d88[] = {
...
const Vtx VB_bully_geo_0x5002e68[] = {
{{{ 55, 28, -41 }, 0, { 0, 0 }, { 255, 127, 0, 255}}},
{{{ -37, 27, 0 }, 0, { 0, 0 }, { 255, 127, 0, 0}}},
{{{ 56, 28, 46 }, 0, { 0, 0 }, { 255, 127, 0, 0}}},
{{{ 90, 28, 0 }, 0, { 0, 0 }, { 255, 127, 0, 255}}},
...
const Vtx VB_bully_geo_0x5003c50[] = {
...
const Vtx VB_bully_geo_0x5003c90[] = {
...
const Vtx VB_bully_geo_0x5000000[] = {
...
const Vtx VB_bully_geo_0x5003f20[] = {
...
const Vtx VB_bully_boss_geo_0x5003db8[] = {
...
const Vtx VB_bully_boss_geo_0x5003df8[] = {
...
const Light_t Light_bully_geo_0x5000410 = {
{ 0, 227, 0}, 0, { 0, 227, 0}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_bully_geo_0x5000408 = {
{0, 56, 0}, 0, {0, 56, 0}, 0
};

const Gfx DL_bully_geo_0x5003708[] = {
...
const Light_t Light_bully_geo_0x5000428 = {
{ 0, 255, 0}, 0, { 0, 255, 0}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_bully_geo_0x5000420 = {
{0, 63, 0}, 0, {0, 63, 0}, 0
};

const Gfx DL_bully_geo_0x50037a0[] = {
...
const Gfx DL_bully_geo_0x5003d40[] = {
gsDPPipeSync(),
...
const Gfx DL_bully_geo_0x5003cd0[] = {
gsDPSetTextureImage(0, 2, 1, texture_bully_geo_0x5000468_custom),
gsDPLoadSync(),
...
const Gfx DL_bully_geo_0x5003d08[] = {
gsDPSetTextureImage(0, 2, 1, texture_bully_geo_0x5001468_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
...
const Gfx DL_bully_geo_0x5000398[] = {
gsDPPipeSync(),
...
const Gfx DL_bully_geo_0x50002e0[] = {
gsDPSetTextureImage(0, 2, 1, texture_bully_geo_0x50000e0_custom),
gsDPLoadSync(),
...
const Gfx DL_bully_geo_0x5003fc8[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_bully_geo_0x5003f80[] = {
gsDPSetTextureImage(0, 2, 1, texture_bully_geo_0x5002468_custom),
gsDPLoadSync(),
...
const Gfx DL_bully_boss_geo_0x5003ea8[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_bully_boss_geo_0x5003e38[] = {
gsDPSetTextureImage(0, 2, 1, texture_bully_geo_0x5000468_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
...
const Gfx DL_bully_boss_geo_0x5003e70[] = {
gsDPSetTextureImage(0, 2, 1, texture_bully_geo_0x5001468_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
