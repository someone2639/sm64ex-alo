...
const Vtx VB_fish_shadow_geo_0x301bde0[] = {
...
const Vtx VB_fish_shadow_geo_0x301c018[] = {
...
const Light_t Light_fish_shadow_geo_0x301b5d0 = {
{ 255, 255, 255}, 0, { 255, 255, 255}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_fish_shadow_geo_0x301b5c8 = {
{63, 63, 63}, 0, {63, 63, 63}, 0
};

const Gfx DL_fish_shadow_geo_0x301bfb8[] = {
gsDPPipeSync(),
...
gsSPDisplayList(DL_fish_shadow_geo_0x301bec0),
...
const Gfx DL_fish_shadow_geo_0x301bec0[] = {
gsDPSetTextureImage(0, 2, 1, texture_fish_shadow_geo_0x301b5e0_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
gsSPLight(&Light_fish_shadow_geo_0x301b5d0.col, 1),
gsSPLight(&Light_fish_shadow_geo_0x301b5c8.col, 2),
gsSPVertex(VB_fish_shadow_geo_0x301bde0, 14, 0),
...
const Gfx DL_fish_shadow_geo_0x301c150[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, SHADE, TEXEL0, 0, SHADE, 0, 0, 0, 0, SHADE),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
gsSPTexture(65535, 65535, 0, 0, 1),
...
gsDPSetTile(0, 2, 8, 0, 0, 0, 2, 5, 0, 2, 5, 0),
gsDPSetTileSize(0, 0, 0, 124, 124),
gsSPDisplayList(DL_fish_shadow_geo_0x301c0a8),
gsSPTexture(65535, 65535, 0, 0, 0),
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE),
gsSPEndDisplayList(),
...
const Gfx DL_fish_shadow_geo_0x301c0a8[] = {
gsDPSetTextureImage(0, 2, 1, texture_fish_shadow_geo_0x301b5e0_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
gsSPLight(&Light_fish_shadow_geo_0x301b5d0.col, 1),
gsSPLight(&Light_fish_shadow_geo_0x301b5c8.col, 2),
gsSPVertex(VB_fish_shadow_geo_0x301c018, 9, 0),
