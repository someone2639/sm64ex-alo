...
const Vtx VB_scuttlebug_geo_0x60142f8[] = {
...
const Vtx VB_scuttlebug_geo_0x60141f8[] = {
...
const Vtx VB_scuttlebug_geo_0x6014110[] = {
...
const Vtx VB_scuttlebug_geo_0x6013908[] = {
...
const Vtx VB_scuttlebug_geo_0x6013948[] = {
...
const Vtx VB_scuttlebug_geo_0x6013a70[] = {
...
const Vtx VB_scuttlebug_geo_0x6013c40[] = {
...
const Vtx VB_scuttlebug_geo_0x6013b58[] = {
{{{ 15, 15, 0 }, 0, { 990, 0 }, { 255, 255, 255, 255}}},
{{{ -15, 15, 0 }, 0, { 0, 0 }, { 255, 255, 255, 255}}},
{{{ -15, -15, 0 }, 0, { 0, 990 }, { 255, 255, 255, 255}}},
{{{ 15, -15, 0 }, 0, { 990, 990 }, { 255, 255, 255, 255}}},
...
const Vtx VB_scuttlebug_geo_0x6013d28[] = {
...
const Vtx VB_scuttlebug_geo_0x6013e28[] = {
...
const Vtx VB_scuttlebug_geo_0x6013f28[] = {
{{{ -103, 89, 199 }, 0, { 0, 0 }, { 124, 238, 243, 255}}},
...
const Light_t Light_scuttlebug_geo_0x60142e8 = {
{ 153, 22, 22}, 0, { 153, 22, 22}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_scuttlebug_geo_0x60142e0 = {
{38, 5, 5}, 0, {38, 5, 5}, 0
};

const Gfx DL_scuttlebug_geo_0x6014378[] = {
gsDPPipeSync(),
...
const Gfx DL_scuttlebug_geo_0x6014338[] = {
...
const Gfx DL_scuttlebug_geo_0x6014270[] = {
gsDPPipeSync(),
...
const Gfx DL_scuttlebug_geo_0x6014238[] = {
gsDPSetTextureImage(0, 2, 1, texture_scuttlebug_geo_0x6013108_custom),
gsDPLoadSync(),
...
const Gfx DL_scuttlebug_geo_0x6014188[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_CULL_BACK|G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_scuttlebug_geo_0x6014150[] = {
gsDPSetTextureImage(0, 2, 1, texture_scuttlebug_geo_0x6013108_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
const Gfx DL_scuttlebug_geo_0x60139f8[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
...
const Gfx DL_scuttlebug_geo_0x6013988[] = {
gsDPSetTextureImage(0, 2, 1, texture_scuttlebug_geo_0x6010908_custom),
gsDPLoadSync(),
...
const Gfx DL_scuttlebug_geo_0x60139c0[] = {
gsDPSetTextureImage(0, 2, 1, texture_scuttlebug_geo_0x6011908_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
...
const Gfx DL_scuttlebug_geo_0x6013ae8[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_scuttlebug_geo_0x6013ab0[] = {
gsDPSetTextureImage(0, 2, 1, texture_scuttlebug_geo_0x6010108_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
const Gfx DL_scuttlebug_geo_0x6013cb8[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_scuttlebug_geo_0x6013c80[] = {
gsDPSetTextureImage(0, 2, 1, texture_scuttlebug_geo_0x6012908_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
const Gfx DL_scuttlebug_geo_0x6013bd0[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_scuttlebug_geo_0x6013b98[] = {
gsDPSetTextureImage(0, 2, 1, texture_scuttlebug_geo_0x6010108_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
const Gfx DL_scuttlebug_geo_0x6013da0[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_scuttlebug_geo_0x6013d68[] = {
gsDPSetTextureImage(0, 2, 1, texture_scuttlebug_geo_0x6012908_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
const Light_t Light_scuttlebug_geo_0x6013e18 = {
{ 207, 137, 6}, 0, { 207, 137, 6}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_scuttlebug_geo_0x6013e10 = {
{51, 34, 1}, 0, {51, 34, 1}, 0
};

const Gfx DL_scuttlebug_geo_0x60140f0[] = {
gsDPPipeSync(),
...
const Gfx DL_scuttlebug_geo_0x6013fc8[] = {
