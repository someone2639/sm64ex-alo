...
const Vtx VB_wiggler_head_geo_0x500c188[] = {
...
const Vtx VB_wiggler_head_geo_0x500c1c8[] = {
...
const Vtx VB_wiggler_head_geo_0x500e588[] = {
...
const Vtx VB_wiggler_head_geo_0x500e5c8[] = {
...
const Vtx VB_wiggler_head_geo_0x500e0e8[] = {
...
const Vtx VB_wiggler_head_geo_0x500e128[] = {
...
const Vtx VB_wiggler_head_geo_0x500e4a0[] = {
...
const Vtx VB_wiggler_head_geo_0x500e368[] = {
...
const Vtx VB_wiggler_head_geo_0x500e250[] = {
...
const Vtx VB_wiggler_head_geo_0x500cd08[] = {
...
const Vtx VB_wiggler_head_geo_0x500cc18[] = {
...
const Vtx VB_wiggler_head_geo_0x500c8d8[] = {
...
const Vtx VB_wiggler_head_geo_0x500c9d8[] = {
{{{ 0, -59, 21 }, 0, { 0, 0 }, { 183, 161, 39, 255}}},
...
const Vtx VB_wiggler_head_geo_0x500cad8[] = {
{{{ 20, -37, 43 }, 0, { 0, 0 }, { 72, 235, 102, 255}}},
{{{ -5, -36, 43 }, 0, { 0, 0 }, { 189, 228, 103, 0}}},
...
const Vtx VB_wiggler_head_geo_0x500cbd8[] = {
{{{ 20, -66, -21 }, 0, { 0, 0 }, { 127, 2, 0, 255}}},
...
const Vtx VB_wiggler_head_geo_0x500d228[] = {
...
const Vtx VB_wiggler_head_geo_0x500d138[] = {
...
const Vtx VB_wiggler_head_geo_0x500cdf8[] = {
...
const Vtx VB_wiggler_head_geo_0x500cef8[] = {
{{{ -17, -33, -21 }, 0, { 0, 0 }, { 137, 227, 225, 255}}},
{{{ -5, -36, -43 }, 0, { 0, 0 }, { 189, 228, 153, 0}}},
...
const Vtx VB_wiggler_head_geo_0x500cff8[] = {
{{{ 20, -66, -21 }, 0, { 0, 0 }, { 66, 161, 206, 255}}},
{{{ 0, -59, -21 }, 0, { 0, 0 }, { 183, 161, 217, 0}}},
{{{ -5, -36, -43 }, 0, { 0, 0 }, { 189, 228, 153, 0}}},
{{{ 20, -37, -43 }, 0, { 0, 0 }, { 72, 235, 154, 255}}},
...
const Vtx VB_wiggler_head_geo_0x500d0f8[] = {
{{{ 20, -37, 43 }, 0, { 0, 0 }, { 27, 231, 121, 255}}},
...
const Gfx DL_wiggler_head_geo_0x500c278[] = {
gsDPPipeSync(),
...
const Gfx DL_wiggler_head_geo_0x500c208[] = {
gsDPSetTextureImage(0, 2, 1, texture_wiggler_head_geo_0x5005a30_custom),
gsDPLoadSync(),
...
const Gfx DL_wiggler_head_geo_0x500c240[] = {
gsDPSetTextureImage(0, 2, 1, texture_wiggler_head_geo_0x5006a30_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
...
const Gfx DL_wiggler_head_geo_0x500e678[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_wiggler_head_geo_0x500e608[] = {
gsDPSetTextureImage(0, 2, 1, texture_wiggler_head_geo_0x5005a30_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
...
const Gfx DL_wiggler_head_geo_0x500e640[] = {
gsDPSetTextureImage(0, 2, 1, texture_wiggler_head_geo_0x5006a30_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
...
const Gfx DL_wiggler_head_geo_0x500e1d8[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_wiggler_head_geo_0x500e168[] = {
gsDPSetTextureImage(0, 2, 1, texture_wiggler_head_geo_0x5009230_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
...
const Gfx DL_wiggler_head_geo_0x500e1a0[] = {
gsDPSetTextureImage(0, 2, 1, texture_wiggler_head_geo_0x500a230_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
...
const Gfx DL_wiggler_head_geo_0x500e518[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
...
const Gfx DL_wiggler_head_geo_0x500e4e0[] = {
gsDPSetTextureImage(0, 2, 1, texture_wiggler_head_geo_0x5008230_custom),
gsDPLoadSync(),
...
const Gfx DL_wiggler_head_geo_0x500e430[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_wiggler_head_geo_0x500e3e8[] = {
gsDPSetTextureImage(0, 2, 1, texture_wiggler_head_geo_0x5007a30_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
const Gfx DL_wiggler_head_geo_0x500e2f8[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_wiggler_head_geo_0x500e2b0[] = {
gsDPSetTextureImage(0, 2, 1, texture_wiggler_head_geo_0x5008a30_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
const Light_t Light_wiggler_head_geo_0x500c898 = {
{ 231, 71, 0}, 0, { 231, 71, 0}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_wiggler_head_geo_0x500c890 = {
{57, 17, 0}, 0, {57, 17, 0}, 0
};

const Gfx DL_wiggler_head_geo_0x500ddf8[] = {
...
const Gfx DL_wiggler_head_geo_0x500dd70[] = {
gsSPLight(&Light_wiggler_head_geo_0x500c898.col, 1),
gsSPLight(&Light_wiggler_head_geo_0x500c890.col, 2),
...
const Light_t Light_wiggler_head_geo_0x500c880 = {
{ 223, 0, 0}, 0, { 223, 0, 0}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_wiggler_head_geo_0x500c878 = {
{55, 0, 0}, 0, {55, 0, 0}, 0
};

const Gfx DL_wiggler_head_geo_0x500dc18[] = {
...
const Gfx DL_wiggler_head_geo_0x500e060[] = {
gsSPLight(&Light_wiggler_head_geo_0x500c898.col, 1),
gsSPLight(&Light_wiggler_head_geo_0x500c890.col, 2),
...
const Gfx DL_wiggler_head_geo_0x500dfd8[] = {
gsSPLight(&Light_wiggler_head_geo_0x500c898.col, 1),
gsSPLight(&Light_wiggler_head_geo_0x500c890.col, 2),
...
const Gfx DL_wiggler_head_geo_0x500de80[] = {
gsSPLight(&Light_wiggler_head_geo_0x500c880.col, 1),
gsSPLight(&Light_wiggler_head_geo_0x500c878.col, 2),
