...
const Vtx VB_bookend_geo_0x5002d70[] = {
...
const Vtx VB_bookend_geo_0x5002e30[] = {
...
gsDPSetTextureImage(0, 2, 1, texture_bookend_geo_0x5000c60_custom),
gsDPLoadSync(),
...
gsDPSetTextureImage(0, 2, 1, texture_bookend_geo_0x5002570_custom),
gsDPLoadSync(),
