...
const Vtx VB_spindrift_geo_0x5000210[] = {
...
const Vtx VB_spindrift_geo_0x5002988[] = {
...
const Vtx VB_spindrift_geo_0x5002a98[] = {
...
const Vtx VB_spindrift_geo_0x50000c0[] = {
...
const Vtx VB_spindrift_geo_0x5000120[] = {
...
const Vtx VB_spindrift_geo_0x5002ba8[] = {
...
const Vtx VB_spindrift_geo_0x50026d0[] = {
...
const Vtx VB_spindrift_geo_0x50027b8[] = {
...
const Gfx DL_spindrift_geo_0x5002900[] = {
gsDPPipeSync(),
...
const Gfx DL_spindrift_geo_0x50028d0[] = {
gsDPSetTextureImage(0, 2, 1, texture_spindrift_geo_0x50006d0_custom),
gsDPLoadSync(),
...
const Light_t Light_spindrift_geo_0x5000098 = {
{ 0, 63, 0}, 0, { 0, 63, 0}, 0, { 40, 40, 40}, 0
};

const Light_t Light_spindrift_geo_0x5000080 = {
{ 255, 226, 0}, 0, { 255, 226, 0}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_spindrift_geo_0x5000090 = {
{0, 15, 0}, 0, {0, 15, 0}, 0
};

const Ambient_t Light_spindrift_geo_0x5000078 = {
{63, 56, 0}, 0, {63, 56, 0}, 0
};

const Gfx DL_spindrift_geo_0x5000328[] = {
...
const Light_t Light_spindrift_geo_0x5002978 = {
{ 255, 255, 255}, 0, { 255, 255, 255}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_spindrift_geo_0x5002970 = {
{127, 127, 127}, 0, {127, 127, 127}, 0
};

const Gfx DL_spindrift_geo_0x5002a20[] = {
gsDPPipeSync(),
...
const Gfx DL_spindrift_geo_0x50029c8[] = {
gsDPSetTextureImage(0, 2, 1, texture_spindrift_geo_0x50016d0_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
gsSPGeometryMode(G_CULL_BACK, 0),
...
const Light_t Light_spindrift_geo_0x5002a88 = {
{ 255, 255, 255}, 0, { 255, 255, 255}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_spindrift_geo_0x5002a80 = {
{127, 127, 127}, 0, {127, 127, 127}, 0
};

const Gfx DL_spindrift_geo_0x5002b30[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
gsSPTexture(65535, 65535, 0, 0, 1),
...
const Gfx DL_spindrift_geo_0x5002ad8[] = {
gsDPSetTextureImage(0, 2, 1, texture_spindrift_geo_0x50016d0_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
gsSPGeometryMode(G_CULL_BACK, 0),
...
const Light_t Light_spindrift_geo_0x5000050 = {
{ 221, 255, 1}, 0, { 221, 255, 1}, 0, { 40, 40, 40}, 0
};

const Light_t Light_spindrift_geo_0x5000038 = {
{ 73, 178, 0}, 0, { 73, 178, 0}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_spindrift_geo_0x5000048 = {
{55, 63, 0}, 0, {55, 63, 0}, 0
};

const Ambient_t Light_spindrift_geo_0x5000030 = {
{18, 44, 0}, 0, {18, 44, 0}, 0
};

const Gfx DL_spindrift_geo_0x50002a0[] = {
...
const Light_t Light_spindrift_geo_0x5002b98 = {
{ 255, 255, 255}, 0, { 255, 255, 255}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_spindrift_geo_0x5002b90 = {
{127, 127, 127}, 0, {127, 127, 127}, 0
};

const Gfx DL_spindrift_geo_0x5002d08[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
gsSPTexture(65535, 65535, 0, 0, 1),
...
const Gfx DL_spindrift_geo_0x5002c98[] = {
gsDPSetTextureImage(0, 2, 1, texture_spindrift_geo_0x5000ed0_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
gsSPGeometryMode(G_CULL_BACK, 0),
...
const Gfx DL_spindrift_geo_0x5002748[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_spindrift_geo_0x5002710[] = {
gsDPSetTextureImage(0, 2, 1, texture_spindrift_geo_0x5001ed0_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
const Gfx DL_spindrift_geo_0x5002830[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_spindrift_geo_0x50027f8[] = {
gsDPSetTextureImage(0, 2, 1, texture_spindrift_geo_0x50006d0_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
