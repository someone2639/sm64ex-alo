...
const Vtx VB_bowling_ball_geo_0x8022bb8[] = {
...
const Vtx VB_bowling_ball_geo_0x8022bf8[] = {
...
gsDPSetTextureImage(0, 2, 1, texture_bowling_ball_geo_0x801da60_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
gsSPVertex(VB_bowling_ball_geo_0x8022bb8, 4, 0),
gsSP2Triangles(0, 1, 2, 0,0, 3, 1, 0),
gsDPSetTextureImage(0, 2, 1, texture_bowling_ball_geo_0x801ea60_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
