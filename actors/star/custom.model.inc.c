...
const Vtx VB_star_geo_0x302b6f0[] = {
...
const Vtx VB_star_geo_0x302b920[] = {
...
gsDPSetTextureImage(0, 2, 1, texture_star_geo_0x302a6f0_custom),
...
gsDPSetTextureImage(0, 2, 1, texture_star_geo_0x302aef0_custom),
gsDPLoadSync(),
