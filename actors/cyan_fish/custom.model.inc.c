...
const Vtx VB_cyan_fish_geo_0x600dc80[] = {
...
const Vtx VB_cyan_fish_geo_0x600df60[] = {
...
const Vtx VB_cyan_fish_geo_0x600de50[] = {
...
gsDPSetTextureImage(0, 2, 1, texture_cyan_fish_geo_0x600d468_custom),
gsDPLoadSync(),
