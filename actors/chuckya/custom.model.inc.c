...
const Vtx VB_chuckya_geo_0x800a9d0[] = {
...
const Vtx VB_chuckya_geo_0x800aac0[] = {
...
const Vtx VB_chuckya_geo_0x800a580[] = {
...
const Vtx VB_chuckya_geo_0x800a908[] = {
...
const Vtx VB_chuckya_geo_0x800a680[] = {
...
const Vtx VB_chuckya_geo_0x8009f78[] = {
...
const Vtx VB_chuckya_geo_0x8009fb8[] = {
...
const Vtx VB_chuckya_geo_0x800a0e0[] = {
...
const Vtx VB_chuckya_geo_0x800a120[] = {
...
const Vtx VB_chuckya_geo_0x800a3b0[] = {
...
const Vtx VB_chuckya_geo_0x800a248[] = {
{{{ 0, 13, 0 }, 0, { 990, 0 }, { 255, 255, 255, 255}}},
{{{ -13, -13, 0 }, 0, { 0, 2012 }, { 255, 255, 255, 255}}},
{{{ 0, -13, 0 }, 0, { 990, 2012 }, { 255, 255, 255, 255}}},
{{{ -13, 13, 0 }, 0, { 0, 0 }, { 255, 255, 255, 255}}},
...
const Vtx VB_chuckya_geo_0x800a288[] = {
{{{ 13, 13, 0 }, 0, { 990, 0 }, { 255, 255, 255, 255}}},
{{{ 0, -13, 0 }, 0, { 0, 2012 }, { 255, 255, 255, 255}}},
{{{ 13, -13, 0 }, 0, { 990, 2012 }, { 255, 255, 255, 255}}},
{{{ 0, 13, 0 }, 0, { 0, 0 }, { 255, 255, 255, 255}}},
...
const Vtx VB_chuckya_geo_0x800a498[] = {
{{{ 23, 23, 0 }, 0, { 990, 0 }, { 255, 255, 255, 255}}},
{{{ -22, 23, 0 }, 0, { 0, 0 }, { 255, 255, 255, 255}}},
{{{ -22, -22, 0 }, 0, { 0, 990 }, { 255, 255, 255, 255}}},
{{{ 23, -22, 0 }, 0, { 990, 990 }, { 255, 255, 255, 255}}},
...
const Vtx VB_chuckya_geo_0x800a7e0[] = {
...
const Light_t Light_chuckya_geo_0x800a9c0 = {
{ 50, 50, 50}, 0, { 50, 50, 50}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_chuckya_geo_0x800a9b8 = {
{12, 12, 12}, 0, {12, 12, 12}, 0
};

const Gfx DL_chuckya_geo_0x800abe8[] = {
gsDPPipeSync(),
...
const Gfx DL_chuckya_geo_0x800ab70[] = {
...
const Gfx DL_chuckya_geo_0x800a5f8[] = {
gsDPPipeSync(),
...
const Gfx DL_chuckya_geo_0x800a5c0[] = {
gsDPSetTextureImage(0, 2, 1, texture_chuckya_geo_0x8007778_custom),
gsDPLoadSync(),
...
const Light_t Light_chuckya_geo_0x800a8f8 = {
{ 255, 255, 0}, 0, { 255, 255, 0}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_chuckya_geo_0x800a8f0 = {
{76, 76, 0}, 0, {76, 76, 0}, 0
};

const Gfx DL_chuckya_geo_0x800a998[] = {
gsDPPipeSync(),
...
const Gfx DL_chuckya_geo_0x800a958[] = {
...
const Light_t Light_chuckya_geo_0x800a670 = {
{ 255, 255, 255}, 0, { 255, 255, 255}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_chuckya_geo_0x800a668 = {
{102, 102, 102}, 0, {102, 102, 102}, 0
};

const Gfx DL_chuckya_geo_0x800a758[] = {
gsDPPipeSync(),
...
const Gfx DL_chuckya_geo_0x800a700[] = {
gsDPSetTextureImage(0, 2, 1, texture_chuckya_geo_0x8006778_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
const Gfx DL_chuckya_geo_0x800a068[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_chuckya_geo_0x8009ff8[] = {
gsDPSetTextureImage(0, 2, 1, texture_chuckya_geo_0x8007f78_custom),
gsDPLoadSync(),
...
const Gfx DL_chuckya_geo_0x800a030[] = {
gsDPSetTextureImage(0, 2, 1, texture_chuckya_geo_0x8008f78_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
...
const Gfx DL_chuckya_geo_0x800a1d0[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_chuckya_geo_0x800a160[] = {
gsDPSetTextureImage(0, 2, 1, texture_chuckya_geo_0x8007f78_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
...
const Gfx DL_chuckya_geo_0x800a198[] = {
gsDPSetTextureImage(0, 2, 1, texture_chuckya_geo_0x8008f78_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
...
const Gfx DL_chuckya_geo_0x800a428[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_chuckya_geo_0x800a3f0[] = {
gsDPSetTextureImage(0, 2, 1, texture_chuckya_geo_0x8007778_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
const Gfx DL_chuckya_geo_0x800a338[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_chuckya_geo_0x800a2c8[] = {
gsDPSetTextureImage(0, 2, 1, texture_chuckya_geo_0x8007f78_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
...
const Gfx DL_chuckya_geo_0x800a300[] = {
gsDPSetTextureImage(0, 2, 1, texture_chuckya_geo_0x8008f78_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
...
const Gfx DL_chuckya_geo_0x800a510[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_chuckya_geo_0x800a4d8[] = {
gsDPSetTextureImage(0, 2, 1, texture_chuckya_geo_0x8007778_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
const Light_t Light_chuckya_geo_0x800a7d0 = {
{ 137, 137, 138}, 0, { 137, 137, 138}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_chuckya_geo_0x800a7c8 = {
{41, 41, 41}, 0, {41, 41, 41}, 0
};

const Gfx DL_chuckya_geo_0x800a8d0[] = {
gsDPPipeSync(),
...
const Gfx DL_chuckya_geo_0x800a870[] = {
