...
const Vtx VB_haunted_chair_geo_0x5004f70[] = {
...
const Vtx VB_haunted_chair_geo_0x5005070[] = {
...
const Vtx VB_haunted_chair_geo_0x5005490[] = {
...
const Vtx VB_haunted_chair_geo_0x5005580[] = {
...
const Vtx VB_haunted_chair_geo_0x5005218[] = {
...
const Vtx VB_haunted_chair_geo_0x5005308[] = {
...
const Vtx VB_haunted_chair_geo_0x5004c78[] = {
...
const Vtx VB_haunted_chair_geo_0x5004d78[] = {
...
const Light_t Light_haunted_chair_geo_0x5004f60 = {
{ 178, 178, 178}, 0, { 178, 178, 178}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_haunted_chair_geo_0x5004f58 = {
{71, 71, 71}, 0, {71, 71, 71}, 0
};

const Gfx DL_haunted_chair_geo_0x5005190[] = {
gsDPPipeSync(),
...
const Gfx DL_haunted_chair_geo_0x50050f0[] = {
gsDPSetTextureImage(0, 2, 1, texture_haunted_chair_geo_0x5004060_custom),
gsDPLoadSync(),
...
const Light_t Light_haunted_chair_geo_0x5005480 = {
{ 178, 178, 178}, 0, { 178, 178, 178}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_haunted_chair_geo_0x5005478 = {
{71, 71, 71}, 0, {71, 71, 71}, 0
};

const Gfx DL_haunted_chair_geo_0x5005680[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, SHADE, TEXEL0, 0, SHADE, 0, 0, 0, 0, SHADE),
gsSPGeometryMode(G_SHADING_SMOOTH, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_haunted_chair_geo_0x50055f0[] = {
gsDPSetTextureImage(0, 2, 1, texture_haunted_chair_geo_0x5003860_custom),
gsDPLoadSync(),
...
const Light_t Light_haunted_chair_geo_0x5005208 = {
{ 178, 178, 178}, 0, { 178, 178, 178}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_haunted_chair_geo_0x5005200 = {
{71, 71, 71}, 0, {71, 71, 71}, 0
};

const Gfx DL_haunted_chair_geo_0x5005408[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, SHADE, TEXEL0, 0, SHADE, 0, 0, 0, 0, SHADE),
gsSPGeometryMode(G_SHADING_SMOOTH, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_haunted_chair_geo_0x5005378[] = {
gsDPSetTextureImage(0, 2, 1, texture_haunted_chair_geo_0x5003860_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
const Light_t Light_haunted_chair_geo_0x5004c68 = {
{ 178, 178, 178}, 0, { 178, 178, 178}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_haunted_chair_geo_0x5004c60 = {
{71, 71, 71}, 0, {71, 71, 71}, 0
};

const Gfx DL_haunted_chair_geo_0x5004ee8[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, SHADE, TEXEL0, 0, SHADE, 0, 0, 0, 0, SHADE),
gsSPGeometryMode(G_SHADING_SMOOTH, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_haunted_chair_geo_0x5004e38[] = {
gsDPSetTextureImage(0, 2, 1, texture_haunted_chair_geo_0x5003060_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
