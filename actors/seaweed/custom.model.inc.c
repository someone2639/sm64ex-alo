...
const Vtx VB_seaweed_geo_0x600a0f8[] = {
...
const Vtx VB_seaweed_geo_0x600a000[] = {
...
const Vtx VB_seaweed_geo_0x6009f08[] = {
...
const Vtx VB_seaweed_geo_0x6009e10[] = {
...
gsDPSetTextureImage(0, 2, 1, texture_seaweed_geo_0x6009610_custom),
gsDPLoadSync(),
...
gsDPSetTextureImage(0, 2, 1, texture_seaweed_geo_0x6008e10_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
gsSPLight(&Light_seaweed_geo_0x6007e00.col, 1),
gsSPLight(&Light_seaweed_geo_0x6007df8.col, 2),
...
gsDPSetTextureImage(0, 2, 1, texture_seaweed_geo_0x6008610_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
gsSPLight(&Light_seaweed_geo_0x6007e00.col, 1),
gsSPLight(&Light_seaweed_geo_0x6007df8.col, 2),
...
gsDPSetTextureImage(0, 2, 1, texture_seaweed_geo_0x6007e10_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
gsSPLight(&Light_seaweed_geo_0x6007e00.col, 1),
gsSPLight(&Light_seaweed_geo_0x6007df8.col, 2),
