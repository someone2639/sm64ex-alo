...
const Vtx VB_skeeter_geo_0x6000990[] = {
...
const Vtx VB_skeeter_geo_0x6000fe0[] = {
...
const Vtx VB_skeeter_geo_0x6000fa0[] = {
...
const Vtx VB_skeeter_geo_0x6000e00[] = {
...
const Vtx VB_skeeter_geo_0x6001110[] = {
{{{ 405, 0, -15 }, 0, { 0, 0 }, { 21, 21, 8, 0}}},
{{{ 0, 0, -15 }, 0, { 0, 0 }, { 21, 21, 8, 0}}},
{{{ 0, 0, 15 }, 0, { 0, 0 }, { 21, 21, 8, 0}}},
{{{ 405, 0, 15 }, 0, { 0, 0 }, { 21, 21, 8, 0}}},
...
const Vtx VB_skeeter_geo_0x60010d0[] = {
{{{ 555, 0, -15 }, 0, { 0, 0 }, { 21, 21, 8, 0}}},
{{{ 0, 0, -15 }, 0, { 0, 0 }, { 21, 21, 8, 0}}},
{{{ 0, 0, 15 }, 0, { 0, 0 }, { 21, 21, 8, 0}}},
{{{ 555, 0, 15 }, 0, { 0, 0 }, { 21, 21, 8, 0}}},
...
const Vtx VB_skeeter_geo_0x6001240[] = {
{{{ 0, 0, -15 }, 0, { 0, 0 }, { 21, 21, 8, 0}}},
{{{ 0, 0, 15 }, 0, { 0, 0 }, { 21, 21, 8, 0}}},
{{{ 405, 0, 15 }, 0, { 0, 0 }, { 21, 21, 8, 0}}},
{{{ 405, 0, -15 }, 0, { 0, 0 }, { 21, 21, 8, 0}}},
...
const Vtx VB_skeeter_geo_0x6001200[] = {
{{{ 0, 0, -15 }, 0, { 0, 0 }, { 21, 21, 8, 0}}},
{{{ 0, 0, 15 }, 0, { 0, 0 }, { 21, 21, 8, 0}}},
{{{ 555, 0, 15 }, 0, { 0, 0 }, { 21, 21, 8, 0}}},
{{{ 555, 0, -15 }, 0, { 0, 0 }, { 21, 21, 8, 0}}},
...
const Vtx VB_skeeter_geo_0x6000b60[] = {
...
const Vtx VB_skeeter_geo_0x6001b30[] = {
{{{ 0, 0, -15 }, 0, { 0, 0 }, { 21, 21, 8, 0}}},
{{{ 0, 0, 15 }, 0, { 0, 0 }, { 21, 21, 8, 0}}},
{{{ 555, 0, 15 }, 0, { 0, 0 }, { 21, 21, 8, 0}}},
{{{ 555, 0, -15 }, 0, { 0, 0 }, { 21, 21, 8, 0}}},
...
const Vtx VB_skeeter_geo_0x60037b0[] = {
...
const Vtx VB_skeeter_geo_0x6000a78[] = {
...
const Gfx DL_skeeter_geo_0x6000a08[] = {
gsDPPipeSync(),
...
const Gfx DL_skeeter_geo_0x60009d0[] = {
gsDPSetTextureImage(0, 2, 1, texture_skeeter_geo_0x6000090_custom),
gsDPLoadSync(),
...
const Gfx DL_skeeter_geo_0x6004070[] = {
...
const Gfx DL_skeeter_geo_0x6004040[] = {
gsSPGeometryMode(G_CULL_BACK|G_LIGHTING|G_SHADING_SMOOTH, 0),
...
const Light_t Light_skeeter_geo_0x6000df0 = {
{ 255, 170, 0}, 0, { 255, 170, 0}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_skeeter_geo_0x6000de8 = {
{127, 85, 0}, 0, {127, 85, 0}, 0
};

const Gfx DL_skeeter_geo_0x6000ec0[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE),
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE),
...
const Gfx DL_skeeter_geo_0x6000e60[] = {
...
const Gfx DL_skeeter_geo_0x6004120[] = {
gsSPGeometryMode(G_CULL_BACK|G_LIGHTING|G_SHADING_SMOOTH, 0),
...
const Gfx DL_skeeter_geo_0x60040f0[] = {
gsSPGeometryMode(G_CULL_BACK|G_LIGHTING|G_SHADING_SMOOTH, 0),
...
const Gfx DL_skeeter_geo_0x60041d0[] = {
gsSPGeometryMode(G_CULL_BACK|G_LIGHTING|G_SHADING_SMOOTH, 0),
...
const Gfx DL_skeeter_geo_0x60041a0[] = {
gsSPGeometryMode(G_CULL_BACK|G_LIGHTING|G_SHADING_SMOOTH, 0),
...
const Gfx DL_skeeter_geo_0x6000bd8[] = {
gsDPPipeSync(),
...
const Gfx DL_skeeter_geo_0x6000ba0[] = {
gsDPSetTextureImage(0, 2, 1, texture_skeeter_geo_0x6000090_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
const Gfx DL_skeeter_geo_0x6000ca8[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_skeeter_geo_0x6000c78[] = {
gsDPSetTextureImage(0, 2, 1, texture_skeeter_geo_0x6000890_custom),
gsDPLoadSync(),
...
const Gfx DL_skeeter_geo_0x6000d78[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_skeeter_geo_0x6000d48[] = {
gsDPSetTextureImage(0, 2, 1, texture_skeeter_geo_0x6000890_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 127, 512),
...
const Gfx DL_skeeter_geo_0x6004648[] = {
gsSPGeometryMode(G_CULL_BACK|G_LIGHTING|G_SHADING_SMOOTH, 0),
...
const Gfx DL_skeeter_geo_0x6004618[] = {
gsSPGeometryMode(G_CULL_BACK|G_LIGHTING|G_SHADING_SMOOTH, 0),
...
const Gfx DL_skeeter_geo_0x6005328[] = {
gsSPGeometryMode(G_CULL_BACK|G_LIGHTING|G_SHADING_SMOOTH, 0),
...
const Gfx DL_skeeter_geo_0x6000af0[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0, TEXEL0, 0, SHADE, 0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_skeeter_geo_0x6000ab8[] = {
gsDPSetTextureImage(0, 2, 1, texture_skeeter_geo_0x6000090_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
