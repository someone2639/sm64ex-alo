...
const Vtx VB_marios_winged_metal_cap_geo_0x3022750[] = {
...
const Vtx VB_marios_winged_metal_cap_geo_0x30227c0[] = {
...
const Vtx VB_marios_winged_metal_cap_geo_0x30228c0[] = {
...
const Vtx VB_marios_winged_metal_cap_geo_0x30229b0[] = {
{{{ -76, 84, -60 }, 0, { 0, 0 }, { 213, 110, 211, 255}}},
{{{ -41, 144, 64 }, 0, { 0, 0 }, { 220, 121, 0, 255}}},
{{{ 76, 84, -60 }, 0, { 0, 0 }, { 42, 108, 207, 255}}},
...
const Vtx VB_marios_winged_metal_cap_geo_0x3022aa0[] = {
{{{ 86, 1, -60 }, 0, { 0, 0 }, { 32, 134, 254, 255}}},
{{{ -86, 1, -60 }, 0, { 0, 0 }, { 206, 140, 246, 255}}},
{{{ -52, 0, -118 }, 0, { 0, 0 }, { 210, 157, 193, 255}}},
{{{ 33, 17, 109 }, 0, { 0, 0 }, { 251, 132, 234, 255}}},
...
const Vtx VB_marios_winged_metal_cap_geo_0x3022d38[] = {
...
const Vtx VB_marios_winged_metal_cap_geo_0x3022df8[] = {
...
const Light_t Light_marios_winged_metal_cap_geo_0x301cf28 = {
{ 255, 255, 255}, 0, { 255, 255, 255}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_marios_winged_metal_cap_geo_0x301cf20 = {
{127, 127, 127}, 0, {127, 127, 127}, 0
};

const Gfx DL_marios_winged_metal_cap_geo_0x3022ff8[] = {
gsDPPipeSync(),
gsSPGeometryMode(0, G_TEXTURE_GEN),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT, TEXEL0, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT),
gsDPSetTextureImage(0, 2, 1, texture_marios_winged_metal_cap_geo_0x301cf50_custom),
...
const Gfx DL_marios_winged_metal_cap_geo_0x3022b30[] = {
...
const Gfx DL_marios_winged_metal_cap_geo_0x3022b68[] = {
...
const Gfx DL_marios_winged_metal_cap_geo_0x3022cc8[] = {
...
const Gfx DL_marios_winged_metal_cap_geo_0x3023108[] = {
gsSPDisplayList(DL_marios_winged_metal_cap_geo_0x3022ed8),
gsDPSetTextureImage(0, 2, 1, texture_marios_winged_metal_cap_geo_0x3020750_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
gsSPDisplayList(DL_marios_winged_metal_cap_geo_0x3022e78),
gsDPSetTextureImage(0, 2, 1, texture_marios_winged_metal_cap_geo_0x3021750_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
...
const Gfx DL_marios_winged_metal_cap_geo_0x3022ed8[] = {
gsDPPipeSync(),
...
const Gfx DL_marios_winged_metal_cap_geo_0x3022e78[] = {
...
const Gfx DL_marios_winged_metal_cap_geo_0x3022ea8[] = {
...
const Gfx DL_marios_winged_metal_cap_geo_0x3022f20[] = {
...
const Gfx DL_marios_winged_metal_cap_geo_0x3023298[] = {
gsDPPipeSync(),
gsSPGeometryMode(0, G_TEXTURE_GEN),
gsDPSetCombineLERP(TEXEL0, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT, TEXEL0, 0, SHADE, 0, 0, 0, 0, ENVIRONMENT),
gsDPSetTextureImage(0, 2, 1, texture_marios_winged_metal_cap_geo_0x301cf50_custom),
...
const Light_t Light_marios_wing_cap_geo_0x301cf40 = {
{ 255, 0, 0}, 0, { 255, 0, 0}, 0, { 40, 40, 40}, 0
};

const Light_t Light_marios_wing_cap_geo_0x301cf10 = {
{ 115, 6, 0}, 0, { 115, 6, 0}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_marios_wing_cap_geo_0x301cf38 = {
{127, 0, 0}, 0, {127, 0, 0}, 0
};

const Ambient_t Light_marios_wing_cap_geo_0x301cf08 = {
{57, 3, 0}, 0, {57, 3, 0}, 0
};

const Gfx DL_marios_wing_cap_geo_0x3022f48[] = {
gsDPPipeSync(),
...
gsDPSetTextureImage(0, 2, 1, texture_marios_wing_cap_geo_0x301df50_custom),
gsDPLoadSync(),
...
const Gfx DL_marios_wing_cap_geo_0x3022d10[] = {
gsSPDisplayList(DL_marios_winged_metal_cap_geo_0x3022b68),
...
const Gfx DL_marios_wing_cap_geo_0x30230b0[] = {
gsSPDisplayList(DL_marios_winged_metal_cap_geo_0x3022ed8),
gsDPSetTextureImage(0, 2, 1, texture_marios_wing_cap_geo_0x301e750_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
gsSPDisplayList(DL_marios_winged_metal_cap_geo_0x3022e78),
gsDPSetTextureImage(0, 2, 1, texture_marios_wing_cap_geo_0x301f750_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
gsSPDisplayList(DL_marios_winged_metal_cap_geo_0x3022ea8),
gsSPDisplayList(DL_marios_winged_metal_cap_geo_0x3022f20),
...
const Gfx DL_marios_wing_cap_geo_0x3023160[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(TEXEL0, SHADE, TEXEL0 ALPHA, SHADE, 0, 0, 0, ENVIRONMENT, TEXEL0, SHADE, TEXEL0 ALPHA, SHADE, 0, 0, 0, ENVIRONMENT),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
gsSPTexture(65535, 65535, 0, 0, 1),
