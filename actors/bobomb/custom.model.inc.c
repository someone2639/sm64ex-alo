...
const Vtx VB_black_bobomb_geo_0x8022bb8[] = {
...
const Vtx VB_black_bobomb_geo_0x8022bf8[] = {
...
const Vtx VB_black_bobomb_geo_0x8022e30[] = {
...
const Vtx VB_black_bobomb_geo_0x8022f30[] = {
...
const Vtx VB_black_bobomb_geo_0x8022f70[] = {
...
const Vtx VB_black_bobomb_geo_0x8023070[] = {
...
const Vtx VB_black_bobomb_geo_0x80230b0[] = {
...
const Vtx VB_black_bobomb_geo_0x8023190[] = {
...
const Vtx VB_black_bobomb_geo_0x8022a60[] = {
...
const Gfx DL_black_bobomb_geo_0x8022d08[] = {
gsDPPipeSync(),
...
const Gfx DL_black_bobomb_geo_0x8022c38[] = {
gsDPSetTextureImage(0, 2, 1, texture_black_bobomb_geo_0x801da60_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
gsSPVertex(VB_black_bobomb_geo_0x8022bb8, 4, 0),
gsSP2Triangles(0, 1, 2, 0,0, 3, 1, 0),
gsDPSetTextureImage(0, 2, 1, texture_black_bobomb_geo_0x801ea60_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
...
const Light_t Light_black_bobomb_geo_0x8022df0 = {
{ 255, 153, 18}, 0, { 255, 153, 18}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_black_bobomb_geo_0x8022de8 = {
{63, 38, 4}, 0, {63, 38, 4}, 0
};

const Gfx DL_black_bobomb_geo_0x8023270[] = {
...
const Gfx DL_black_bobomb_geo_0x8023378[] = {
gsSPLight(&Light_black_bobomb_geo_0x8022df0.col, 1),
gsSPLight(&Light_black_bobomb_geo_0x8022de8.col, 2),
...
const Light_t Light_black_bobomb_geo_0x8022e08 = {
{ 178, 178, 178}, 0, { 178, 178, 178}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_black_bobomb_geo_0x8022e00 = {
{44, 44, 44}, 0, {44, 44, 44}, 0
};

const Gfx DL_black_bobomb_geo_0x8023480[] = {
...
const Gfx DL_black_bobomb_geo_0x8022b58[] = {
gsSPDisplayList(DL_black_bobomb_geo_0x8022ac0),
gsDPSetTextureImage(0, 2, 1, texture_black_bobomb_geo_0x8021a60_custom),
gsDPLoadSync(),
...
const Gfx DL_black_bobomb_geo_0x8022ac0[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_black_bobomb_geo_0x8022b08[] = {
...
const Gfx DL_black_bobomb_geo_0x8022b88[] = {
gsSPDisplayList(DL_black_bobomb_geo_0x8022ac0),
gsDPSetTextureImage(0, 2, 1, texture_black_bobomb_geo_0x8022260_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
gsSPDisplayList(DL_black_bobomb_geo_0x8022b08),
gsSPEndDisplayList(),
...
const Gfx DL_bobomb_buddy_geo_0x8022d78[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_bobomb_buddy_geo_0x8022ca0[] = {
gsDPSetTextureImage(0, 2, 1, texture_bobomb_buddy_geo_0x801fa60_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
gsSPVertex(VB_black_bobomb_geo_0x8022bb8, 4, 0),
gsSP2Triangles(0, 1, 2, 0,0, 3, 1, 0),
gsDPSetTextureImage(0, 2, 1, texture_bobomb_buddy_geo_0x8020a60_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
gsSPVertex(VB_black_bobomb_geo_0x8022bf8, 4, 0),
gsSP2Triangles(0, 1, 2, 0,0, 3, 1, 0),
