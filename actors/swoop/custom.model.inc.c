...
const Vtx VB_swoop_geo_0x6006808[] = {
...
const Vtx VB_swoop_geo_0x6006288[] = {
...
const Vtx VB_swoop_geo_0x6006368[] = {
...
const Vtx VB_swoop_geo_0x6006468[] = {
{{{ 34, -55, 44 }, 0, { 722, 1312 }, { 6, 138, 44, 255}}},
...
const Vtx VB_swoop_geo_0x6006518[] = {
...
const Vtx VB_swoop_geo_0x6006950[] = {
...
const Vtx VB_swoop_geo_0x60069d0[] = {
...
const Vtx VB_swoop_geo_0x6006b58[] = {
...
const Vtx VB_swoop_geo_0x6006c88[] = {
...
const Gfx DL_swoop_geo_0x6006880[] = {
gsDPPipeSync(),
...
const Gfx DL_swoop_geo_0x6006848[] = {
gsDPSetTextureImage(0, 2, 1, texture_swoop_geo_0x6004270_custom),
gsDPLoadSync(),
...
const Light_t Light_swoop_geo_0x6006278 = {
{ 255, 255, 255}, 0, { 255, 255, 255}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_swoop_geo_0x6006270 = {
{121, 121, 121}, 0, {121, 121, 121}, 0
};

const Gfx DL_swoop_geo_0x6006758[] = {
gsDPPipeSync(),
gsDPSetCycleType(G_CYC_2CYCLE),
...
const Gfx DL_swoop_geo_0x60065b8[] = {
gsDPSetTextureImage(0, 2, 1, texture_swoop_geo_0x6004a70_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
const Gfx DL_swoop_geo_0x60066f8[] = {
gsDPSetTextureImage(0, 2, 1, texture_swoop_geo_0x6005270_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
const Light_t Light_swoop_geo_0x6006940 = {
{ 255, 255, 255}, 0, { 255, 255, 255}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_swoop_geo_0x6006938 = {
{121, 121, 121}, 0, {121, 121, 121}, 0
};

const Gfx DL_swoop_geo_0x6006a88[] = {
gsDPPipeSync(),
gsDPSetCycleType(G_CYC_2CYCLE),
gsDPSetRenderMode(G_RM_FOG_SHADE_A, G_RM_AA_ZB_OPA_SURF2),
gsDPSetDepthSource(0),
...
const Gfx DL_swoop_geo_0x6006a10[] = {
gsDPSetTextureImage(0, 2, 1, texture_swoop_geo_0x6005270_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
const Gfx DL_swoop_geo_0x6006a68[] = {
gsSPVertex(VB_swoop_geo_0x60069d0, 4, 0),
gsSP2Triangles(0, 1, 2, 0,0, 2, 3, 0),
gsSPEndDisplayList(),
};

const Gfx DL_swoop_geo_0x6006bd0[] = {
gsDPPipeSync(),
gsDPSetCycleType(G_CYC_2CYCLE),
gsDPSetRenderMode(0, 3356569720),
gsDPSetDepthSource(0),
...
const Gfx DL_swoop_geo_0x6006b98[] = {
gsDPSetTextureImage(0, 2, 1, texture_swoop_geo_0x6005a70_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
const Gfx DL_swoop_geo_0x6006d00[] = {
gsDPPipeSync(),
gsDPSetCycleType(G_CYC_2CYCLE),
gsDPSetRenderMode(0, 3356569720),
gsDPSetDepthSource(0),
...
const Gfx DL_swoop_geo_0x6006cc8[] = {
gsDPSetTextureImage(0, 2, 1, texture_swoop_geo_0x6005a70_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
