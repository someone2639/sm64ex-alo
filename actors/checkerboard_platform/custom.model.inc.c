...
const Vtx VB_checkerboard_platform_geo_0x800d440[] = {
...
const Vtx VB_checkerboard_platform_geo_0x800d4c0[] = {
...
gsDPSetTextureImage(0, 2, 1, texture_checkerboard_platform_geo_0x800c840_custom),
gsDPLoadSync(),
...
gsDPSetTextureImage(0, 2, 1, texture_checkerboard_platform_geo_0x800cc40_custom),
gsDPLoadSync(),
