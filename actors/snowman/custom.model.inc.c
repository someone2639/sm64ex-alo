...
const Vtx VB_mr_blizzard_hidden_geo_0x500c530[] = {
...
const Vtx VB_mr_blizzard_hidden_geo_0x500c570[] = {
...
const Vtx VB_mr_blizzard_hidden_geo_0x500cb08[] = {
...
const Vtx VB_mr_blizzard_hidden_geo_0x500cb48[] = {
...
const Vtx VB_mr_blizzard_hidden_geo_0x500cc70[] = {
...
const Vtx VB_mr_blizzard_hidden_geo_0x500c698[] = {
...
const Vtx VB_mr_blizzard_hidden_geo_0x500c488[] = {
...
const Vtx VB_mr_blizzard_hidden_geo_0x500c7e8[] = {
...
const Vtx VB_mr_blizzard_hidden_geo_0x500c8e8[] = {
{{{ 69, -56, 36 }, 0, { 704, 810 }, { 4, 232, 124, 255}}},
{{{ 57, -20, 36 }, 0, { 546, 864 }, { 2, 248, 126, 255}}},
...
const Gfx DL_mr_blizzard_hidden_geo_0x500c620[] = {
gsDPPipeSync(),
...
const Gfx DL_mr_blizzard_hidden_geo_0x500c5b0[] = {
gsDPSetTextureImage(0, 2, 1, texture_mr_blizzard_hidden_geo_0x5009470_custom),
gsDPLoadSync(),
...
const Gfx DL_mr_blizzard_hidden_geo_0x500c5e8[] = {
gsDPSetTextureImage(0, 2, 1, texture_mr_blizzard_hidden_geo_0x500a470_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
...
const Gfx DL_mr_blizzard_hidden_geo_0x500cbf8[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_mr_blizzard_hidden_geo_0x500cb88[] = {
gsDPSetTextureImage(0, 2, 1, texture_mr_blizzard_hidden_geo_0x5009470_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
...
const Gfx DL_mr_blizzard_hidden_geo_0x500cbc0[] = {
gsDPSetTextureImage(0, 2, 1, texture_mr_blizzard_hidden_geo_0x500a470_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 2047, 256),
...
const Gfx DL_mr_blizzard_hidden_geo_0x500cce8[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_mr_blizzard_hidden_geo_0x500ccb0[] = {
gsDPSetTextureImage(0, 2, 1, texture_mr_blizzard_hidden_geo_0x500bc70_custom),
gsDPLoadSync(),
...
const Gfx DL_mr_blizzard_hidden_geo_0x500c760[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0, 0, 0, 0, TEXEL0),
gsSPGeometryMode(G_LIGHTING, 0),
gsDPSetTile(0, 2, 0, 0, 7, 0, 0, 0, 0, 0, 0, 0),
...
const Gfx DL_mr_blizzard_hidden_geo_0x500c718[] = {
gsDPSetTextureImage(0, 2, 1, texture_mr_blizzard_hidden_geo_0x500b470_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
...
const Light_t Light_mr_blizzard_hidden_geo_0x500c478 = {
{ 56, 30, 14}, 0, { 56, 30, 14}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_mr_blizzard_hidden_geo_0x500c470 = {
{28, 15, 7}, 0, {28, 15, 7}, 0
};

const Gfx DL_mr_blizzard_hidden_geo_0x500c500[] = {
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE),
gsDPPipeSync(),
gsDPSetCombineLERP(0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE, 0, 0, 0, SHADE),
...
const Gfx DL_mr_blizzard_hidden_geo_0x500c4c8[] = {
...
const Light_t Light_mr_blizzard_hidden_geo_0x500c7d8 = {
{ 255, 255, 255}, 0, { 255, 255, 255}, 0, { 40, 40, 40}, 0
};

const Ambient_t Light_mr_blizzard_hidden_geo_0x500c7d0 = {
{127, 127, 127}, 0, {127, 127, 127}, 0
};

const Gfx DL_mr_blizzard_hidden_geo_0x500caa8[] = {
gsDPPipeSync(),
...
const Gfx DL_mr_blizzard_hidden_geo_0x500c978[] = {
gsDPSetTextureImage(0, 2, 1, texture_mr_blizzard_hidden_geo_0x5008c70_custom),
gsDPLoadSync(),
gsDPLoadBlock(7, 0, 0, 1023, 256),
