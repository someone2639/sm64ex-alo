...
const Vtx VB_wave_trail_geo_0x4025318[] = {
...
gsDPPipeSync(),
gsDPSetTextureImage(3, 2, 1, texture_wave_trail_geo_0x4025358_custom),
...
gsDPPipeSync(),
gsDPSetTextureImage(3, 2, 1, texture_wave_trail_geo_0x4025b58_custom),
gsSPBranchList(DL_wave_trail_geo_0x40273d8),
};

const Gfx DL_wave_trail_geo_0x4027420[] = {
gsDPPipeSync(),
gsDPSetTextureImage(3, 2, 1, texture_wave_trail_geo_0x4026358_custom),
gsSPBranchList(DL_wave_trail_geo_0x40273d8),
};

const Gfx DL_wave_trail_geo_0x4027438[] = {
gsDPPipeSync(),
gsDPSetTextureImage(3, 2, 1, texture_wave_trail_geo_0x4026b58_custom),
gsSPBranchList(DL_wave_trail_geo_0x40273d8),
};
