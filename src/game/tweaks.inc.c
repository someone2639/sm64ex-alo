...
#define HUD_COINS_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(144)
#define HUD_COINS_Y 209
#define HUD_COINS_CROSS_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(130)
#define HUD_COINS_CROSS_Y 209
#define HUD_COINS_NUM_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(116)
...
#define HUD_STARS_NUM_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(49)
