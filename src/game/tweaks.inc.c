...
#define HUD_COINS_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(200)
#define HUD_COINS_Y 209
#define HUD_COINS_CROSS_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(214)
#define HUD_COINS_CROSS_Y 209
#define HUD_COINS_NUM_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(228)
#define HUD_COINS_NUM_Y 209
#define HUD_STARS_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(240)
#define HUD_STARS_Y 209
#define HUD_STARS_CROSS_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(244)
#define HUD_STARS_CROSS_Y 209
#define HUD_STARS_NUM_X GFX_DIMENSIONS_RECT_FROM_RIGHT_EDGE(258)
